			...
			<table class="table table-striped table-hover" ng-if="data.dataList.length">
				...
				<thead>
					<tr>
						...
						<th style="width: 100px;" class="text-center">PAN Status</th>
					...
					<tr scope="row" ng-repeat="(key, row) in data.dataList"  >
                       ...
                       <td class="text-center">
						...
						<td>
							...
							<div class="form-group" ng-if="row.MediaPAN.MediaCaption.PanCardNumber">
								<label class="control-label">PAN Number</label>
								<p class="text-muted">{{row.MediaPAN.MediaCaption.PanCardNumber}}</p>
							</div>
							<div class="form-group" ng-if="row.MediaPAN.MediaCaption.CountryCode">
