    ...
    $scope.exportContests = function () { 
        if ($scope.data.dataList.length > 0) {
            ...
            for (var i = 0; i < $scope.data.dataList.length; i++) {
                ...
                row.ContestType = $scope.data.dataList[i]['ContestType'];
            ...
            $scope.JSONToCSVConvertor(varArr, 'export-contest-list', true);
        }
        else {
            alertify.error('Contest Not Found');
        }
    }
