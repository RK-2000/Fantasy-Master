app.controller('PageController', function ($scope, $http,$timeout){
    ...
    $scope.getList = function ()
    {
        ...
        var data = 'SessionKey='+SessionKey+'&Params=Amount,Email,PhoneNumber,PaymentGateway,Status,EntryDate,FirstName,MediaBANK&PageNo=' + $scope.data.pageNo + '&PageSize=' + $scope.data.pageSize + '&OrderBy=EntryDate&Sequence=DESC&' + $('#filterForm1').serialize()+'&'+$('#filterForm').serialize();
    ...
    $scope.editData = function(Status) {
        ...
        var data = 'SessionKey=' + SessionKey +'&Comments='+person+ '&Params=WithdrawalID,Amount,PaymentGateway,Status,EntryDate,FirstName,Email,PhoneNumber&' + $('#edit_form').serialize();
