                ...
                <form id="filterForm1" role="form" autocomplete="off" class="ng-pristine ng-valid">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="filter-col" for="DraftFormat">Draft Format</label>
                                        <select id="DraftFormat" name="DraftFormat"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="filter-col" for="DraftType">Draft Type</label>
                                        <select id="DraftType" name="DraftType" class="form-control chosen-select">
                                            <option value="">Please Select</option>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary btn-sm"
                            onclick="$('.filter-matches').remove();$('#filterForm1').trigger('reset'); $('.chosen-select').trigger('chosen:updated');">Reset</button>
