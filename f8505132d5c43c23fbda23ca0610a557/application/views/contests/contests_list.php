                ...
                <tr scope="row" ng-repeat="(key, row) in data.dataList"
                    ...
                    <td>
                        <div class="content float-left"><strong><a href="javascript:void(0)"
                            ...
                            <div ng-if="row.TeamNameLocal">({{row.TeamNameLocal}} v/s {{row.TeamNameVisitor}})</div>
                            <div ng-if="!row.TeamNameLocal">-</div>
                        </div>
                    </td>
                    <td>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-left">
                                ...
                                <a class="dropdown-item" target="_blank"
                                    href="userjoined?ContestGUID={{row.ContestGUID}}">Joined Users</a>
                            </div>
                        </div>
                    </td>
                </tr>
