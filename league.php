                                    ...
                                    <li>
                                        ...
                                        <div class="payoutMsg">
                                            ...
                                            <div class="payoutParBox" ng-if="Contest.WinningAmount > 0">
                                                <a href="javascript:void(0)" ng-click="showWinningPayout(Contest.CustomizeWinning)">
                                                    <p><i class="fa fa-star" aria-hidden="true"></i> View Payout Breakup</p>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="player_tab_table  team_info">
                                            ...
                                            <div class="table_scroll" scrolly style="max-height: 800px;overflow-y: scroll;">
                                                <table class="table-fixed">
                                                    <tbody>
                                                        <tr ng-repeat="team in userTeams| orderBy:propertyName:reverse" ng-click="ViewTeamOnGround(team, Contest.Status)" class="{{SelectedUserGUID == team.UserGUID ? 'myuser' : ''}}">
                                                            <td class="text-center " style="text-transform: uppercase;">{{team.Username}}(T{{getTeamName(team.UserTeamName)}})</td>
                                                            <td class="text-center " ng-if="Contest.Status == 'Completed' && team.UserRank == '1'"><img src="assets/img/winner-free.svg" width='20'>
                                                                <p>Champion</p>
                                                            </td>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="white_bg table no-margin text-left ng-scope" ng-if="fields.matchDataObject.m_t != 'Test'">
                            ...
                            <tbody>
                                <tr ng-if="fantasyScores.Records" ng-repeat="scorecard in fantasyScores.Records" class="all">
                                    <td>
                                ...
                                <tr ng-if="fantasyScores.PointsData" class="single">
                                    <td>
                                        {{fantasyScores.PlayerName}}
                                    </td>
                                    <td ng-repeat="pointdata in fantasyScores.PointsData track by $index">
                                        <p>{{pointdata.CalculatedPoints}}</p>
                                    </td>
                                    <td>
                                        {{fantasyScores.TotalPoints}}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
