                                        ...
                                        <div class="player_tab_table  team_info">
                                            ...
                                            <div class="table_scroll" scrolly>
                                                <table class="table-fixed" >
                                                    <tbody>
                                                        <tr ng-repeat="team in userTeams| orderBy:propertyName:reverse" ng-click="ViewTeamOnGround(team.UserTeamGUID, team.UserGUID)" class="{{SelectedUserTeamGUID==team.UserTeamGUID ? 'active' : '' }}">
