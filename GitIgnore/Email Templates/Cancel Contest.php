          ...
          <table class="main-wrapper" width="610" border="0" cellspacing="0" cellpadding="0" align="center" style=" border-radius:5px;">
            <tr>
              <td colspan="2" class="content-padding" style="padding:40px 40px 20px; border-bottom:1px solid #E5E5E5;background:#FFFFFF;" >
                ...
                <p style="font-family: 'Roboto', sans-serif; font-size:16px; color:#444444; font-weight:500; margin-bottom:30px;">We regret to inform you that your joined  {{ContestName}} has been cancelled.</p><p>Contest joining amount will be refund in your wallet for same.</p><br>
        
                <p style="font-family: 'Roboto', sans-serif; font-size:16px; color:#444444; font-weight:500; margin-bottom:30px;">
                  Series Name: {{SeriesName}}
                  <br>Match No: {{MatchNo}}
                  <br>Team Name Local: {{TeamNameLocal}}
                  <br>Team Name Visitor: {{TeamNameVisitor}}
                </p>
                <p>We are continuously working towards providing better user experience. Feel free to contact us if there has been a mistake. </p>
                <br>
