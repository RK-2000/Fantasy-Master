...
function send_mail($emailData = array())
{
    ...
    // sending email 
    $apiKey = 'SG.utLwQDhwSfik_-oxahrViQ.xu7v9zxwv5u_FM0c506ro6oPf-M8qKvI9djQ_0yt5SU111111323cdd2321';
...
function mongoDBConnection()
{
    ...
    switch (ENVIRONMENT) {
        ...
        case 'testing':
            ...
            $Obj->ClientObj = new MongoDB\Client("mongodb://cric91user:mp7tYx2e@172.31.13.58:27017,172.31.17.218:27017/?replicaSet=rs0");
            break;
        case 'demo':
            $Obj->ClientObj = new MongoDB\Client("mongodb://fantasyadmincric91:fantasymw123crick91@localhost:27017");
            break;
        default :
            $Obj->ClientObj = new MongoDB\Client("mongodb://cric91user:mp7tYx2e@172.31.13.58:27017,172.31.17.218:27017?replicaSet=rs0");
           break;
    }
    $Obj->fantasydb = $Obj->ClientObj->cric91;
}
