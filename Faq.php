            ...
            <div class="container mt-4">
                <div class=" faq_content ">
                        <div id="tab5" class="tabcontent"><h3>REGISTRATION ON FSL11</h3>
                          ...
                          <p> It’s easy! Once you are on&nbsp;<a href="authenticate" target="_blank">FSL11.com</a>&nbsp;, register by filling out a short form or connect instantly with your Facebook or Google+ account.</p>
                          ...
                          <p> You can create only one account with one email id on&nbsp;<a href="authenticate" target="_blank">FSL11.com</a>. Creation of multiple accounts by a single user is strictly prohibited and violates our Fair Play policy.</p>

                          <h5> 4. Can I update / edit my information? </h5>
                          <p>Yes, you can! Simply log into&nbsp;&nbsp;<a href="authenticate" target="_blank">FSL11.com</a>&nbsp;and click on ‘Edit Profile’ on the top-right corner of the page. You will be able to update/edit your full name and mobile number. You can also edit your date of birth, address and state if your FSL11 account is ‘Unverified’. <strong> Remember, the team name chosen by you and the e-mail ID once registered cannot be changed. </strong></p>

                          <h5> 5. I’m sure I've got the right username and password but I still can't log in. </h5>
                          <p>That’s strange but we will help guide you! If you are a registered user on&nbsp;<a href="authenticate" target="_blank">FSL11.com</a>&nbsp;and are entering the correct details, please reach out to us via our Help Desk feature. Our Customer Support team will be happy to assist you.</p>
                          ...
                          <p>This is a bonus amount given by&nbsp;<a href="authenticate" target="_blank">FSL11.com</a>&nbsp;&nbsp;to you. This amount is non-withdrawable and can be used to join more contests and win more cash. Also, make sure to use the received Cash Bonus as it comes with an expiry date.</p>
